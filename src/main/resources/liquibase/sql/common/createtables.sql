...
create table item(id int unsigned primary key auto_increment, name varchar(100), initialprice decimal, auctionstart timestamp, 
	auctionend timestamp default CURRENT_TIMESTAMP, description text);
...
create table bid(id int unsigned primary key auto_increment, amount decimal not null, createdon timestamp not null, endedon timestamp default CURRENT_TIMESTAMP);
